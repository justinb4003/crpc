...
cq.exporters.export(fan_plate, f'output/cr_fanplate_{fan_width}mm.stl')
cq.exporters.export(fan_plate, f'output/cr_fanplate_{fan_width}mm.step')


for nofan_width in [25, 100]:
    nofan_plate = (
        cq.Workplane("XY")
    ...
    nofan_plate = nofan_plate.faces(">Z").edges("|X").fillet(1.5)
    cq.exporters.export(nofan_plate, f'output/cr_nofanplate_{nofan_width}mm.stl')
    cq.exporters.export(nofan_plate, f'output/cr_nofanplate_{nofan_width}mm.step')

for corner_width in [25, 65, 100]:
    corner_plate = (
        cq.Workplane("XY")
    ...
    cq.exporters.export(corner_plate, f'output/cr_corner_{corner_width}mm.stl')
    cq.exporters.export(corner_plate, f'output/cr_corner_{corner_width}mm.step')
